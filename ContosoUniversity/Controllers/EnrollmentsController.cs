...
namespace ContosoUniversity.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["FirstMidName"] = new SelectList(_context.Students, "ID", "FirstMidName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,CourseID,StudentID,Grade")] Enrollment enrollment)
        {
            ...
            else
            {
                ...
                ViewData["FirstMidName"] = new SelectList(_context.Students, "ID", "FirstMidName", enrollment.StudentID);
